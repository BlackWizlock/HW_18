DATABASE = {
        ...
        "directors": [
                {"name": "Тейлор Шеридан", "pk": 1},
                {"name": "Квентин Тарантино", "pk": 2},
                {"name": "Владимир Вайншток", "pk": 3},
                {"name": "Декстер Флетчер", "pk": 4},
                {"name": "Стив Энтин", "pk": 5},
                {"name": "Роб Маршалл", "pk": 6},
                {"name": "Баз Лурман", "pk": 7},
                {"name": "Дэмьен Шазелл", "pk": 8},
                {"name": "Пьетро Антон", "pk": 9},
                {"name": "Джеймс Мэнголд", "pk": 10},
                {"name": "Дени Вильнёв", "pk": 11},
                {"name": "Кирилл Серебренников", "pk": 12},
                {"name": "Рубен Фляйшер", "pk": 13},
                {"name": "Стэнли Кубрик", "pk": 14},
                {"name": "Ричард Келли", "pk": 15},
                {"name": "Пит Доктер", "pk": 16},
                {"name": "Кемп Пауэрс", "pk": 17},
                {"name": "Бибо Бержерон", "pk": 18},
                {"name": "Тоби Генкель", "pk": 19},
